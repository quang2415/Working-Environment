		...
		if not node.isLeaf:
			if node.threshold is None:
				...
				for index,child in enumerate(node.children):
					if child.isLeaf:
						# print(indent + node.label + " = " + attributes[index] + " : " + child.label)  #before-fix
						print(indent + node.label + " = " + self.attributes[index] + " : " + child.label)
					else:
						# print(indent + node.label + " = " + attributes[index] + " : ")   #before-fix
			...
			if self.isAttrDiscrete(attribute):
				...
				for row in curData:
					for index in range(len(valuesForAttribute)):
						# if row[i] == valuesForAttribute[index]:  before fix
